...
class Data_customer extends CI_Controller{
  ...
  public function index(){
    $data['customer'] = $this->booking_model->get_data('customer')->result();
  ...
  public function tambah_customer_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      $this->booking_model->insert_data($data, 'customer');
  ...
  public function update_customer_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      $where = array('id_customer' => $id);
      $this->booking_model->update_data('customer', $data, $where);
      $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  public function delete_customer($id){
    $where = array('id_customer' => $id);
    $this->booking_model->delete_data($where, 'customer');
    $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
