        ...
        <div class="card-body">
          ...
          <?php foreach($transaksi as $tr): ?>
            ...
            <tr class="text-success">
              ...
              <td>:</td>
              <td><button class="btn btn-sm btn-success">Rp.<?= number_format($tr->harga * $tr->jumlah_kursi, 0, ',', '.'); ?>,-</button></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td><a href="<?= base_url('customer/transaksi/cetak_invoice/'.$tr->id_booking) ?>" class="btn btn-sm btn-secondary">Print Invoice</a></td>
            </tr>
